  ...
  return (
    ...
    <View className='flex-1 justify-center items-center'>
      ...
      <View style={{ width: wp(90) }}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('TabNavigation')} className='bg-[#f9c22d] rounded-lg font-bold' style={{ paddingVertical: hp(2) }}>
      ...
      <View className='px-4 flex-row items-center justify-between' style={{ width: wp(100), marginBottom: hp(4) }}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Signup')} className='flex-row items-center gap-1'>
